...
class DetailsActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            var courseList = mutableStateListOf<Donors?>()
            ...
            db.collection("Courses").get()
                .addOnSuccessListener { queryDocumentSnapshots ->
                    if (!queryDocumentSnapshots.isEmpty) {
                        ...
                        for (d in list) {
                            val c: Donors? = d.toObject(Donors::class.java)
                            courseList.add(c)
...
fun firebaseUI(context: Context, courseList: SnapshotStateList<Donors?>) {
                ...
                Card(
                    ...
                    Column(modifier = Modifier
                        ...
                        Row {
                            ...
                            courseList[index]?.donorName?.let {
                                Text(
                                    text = it,
                        ...
                        Row {
                            ...
                            courseList[index]?.contactInfo?.let {
                                Text(
                                    text = it,
                                    modifier = Modifier.padding(4.dp),
                                    color = Color.Black,
